...
class Configuration:
    ...
    def get_data_validation_config(self) ->DataValidationConfig:
        try:
            ...
            scheme_file_path = os.path.join(ROOT_DIR,
            ...
            data_validation_config = DataValidationConfig(
                scheme_file_path=scheme_file_path,
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            transformed_train_dir=os.path.join(
                ...
                data_transformation_config_info[DATA_TRANSFORMATION_TRAIN_NAME_DIR_KEY]
            )

            transformed_test_dir=os.path.join(
                data_transformation_artifact_dir,
                data_transformation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],
                data_transformation_config_info[DATA_TRANSFORMATION_TEST_NAME_DIR_KEY]
            )
